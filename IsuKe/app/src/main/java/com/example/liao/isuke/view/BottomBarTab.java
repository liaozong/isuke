...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.homeword_noclick));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.homeword_noclick));
...
//        mTvUnreadCount.setBackgroundResource(R.drawable.bg_msg_bubble);//消息气泡背景
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.org_login_word));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.org_login_word));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.homeword_noclick));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.homeword_noclick));
        }
    }
